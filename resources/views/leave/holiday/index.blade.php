        ...
        <div class="content-header-left col-12 mb-2 mt-1">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    ...
                    @endif
                    <h5 class="content-header-title float-left pr-1 mb-0">Holiday Table</h5>
                ...
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body card-dashboard">
                            <form action="{{ route('leave-holidays.year') }}" method="get" enctype="multipart/form-data"> @csrf
                                <fieldset>
                                    <div class="row">
                                        <div class="col-sm-6">
                                    <h5>Year</h5>
                                ...
                                <div class="col-sm-3">
                                    <button type="submit" class="btn btn-primary mt-2 btn-lg mx-1">Search</button>
                                </div>
                                    </div>
                                </fieldset>
                            </form>
                        ...
                        <div class="card-header">
                            ...
                            <div class="heading-elements">
                                <ul class="list-inline mb-0">
                                    <li class="ml-2"><a href="{{ route('leave-holidays.create') }}" class="btn btn-primary">+ Create</a></li>
                                </ul>
                            </div>
                        </div>
                        <div class="card-content">
                                        ...
                                        <tbody>
                                            @if ($holidays)
                                                @foreach ($holidays as $holiday)
                                                    <tr>
                                                        <td class="text-bold-600" >{{ $holiday->title }}</td>
                                                        ...
                                                        <td>
                                                            <div class="dropdown">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right">
                                                                    <a class="dropdown-item" href="{{ route('leave-holidays.edit',$holiday->id) }}"><i class="bx bx-edit-alt mr-1"></i> edit</a>
                                                                    <form action="{{ route('leave-holidays.destroy',$holiday->id) }}" method="post"> @csrf @method('Delete')
