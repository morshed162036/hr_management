...
<div class="content-header row">
    <div class="content-header-left col-12 mb-2 mt-1">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h5 class="content-header-title float-left pr-1 mb-0">Holiday Edit</h5>
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb p-0 mb-0">
                        <li class="breadcrumb-item"><a href="{{ route('dashboard') }}"><i class="bx bx-home-alt"></i></a>
                        </li>
                        <li class="breadcrumb-item"><a href="{{ route('leave-holidays.index') }}">Holidays</a>
                        </li>
                        <li class="breadcrumb-item active">Holiday Edit
                        </li>
                    </ol>
                </div>
            </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-content">
                        <form action="{{ route('leave-holidays.update',$holiday->id) }}" method="post" enctype="multipart/form-data"> @csrf @method('put')
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-10">
                                        <fieldset>
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Holiday Title" aria-describedby="basic-Createon1" name="title" value="{{ $holiday->title }}" required>
                                            </div>
                                        </fieldset>
                                        <fieldset>
                                            <h5>Year <span class="star">*</span></h5>
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text" id="basic-Createon1"><i class="bx bx-file"></i></span>
                                                </div>
                                                <input type="text" class="form-control" placeholder="Year" aria-describedby="basic-Createon1" name="year" value="{{ $holiday->year }}" readonly>
                                            </div>
                                        </fieldset>
                                        <fieldset>
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="date" class="form-control"  aria-describedby="basic-Createon1" name="holiday_date" value="{{ $holiday->holiday_date }}" required>
                                            </div>
                                        </fieldset>
                                        <fieldset>
                                            ...
                                            <div class="input-group">
                                                ...
                                                <select name="holiday_type" id="" class="form-control">
                                                    ...
                                                    <option @if ($holiday->holiday_type == 'Govt')
                                                        selected
                                                    @endif value="Govt">Govt</option>
                                                    <option @if ($holiday->holiday_type == 'Company')
                                                        selected
                                        ...
                                        <fieldset class="mt-2">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <textarea class="form-control" id="basicTextarea" rows="3" placeholder="" name="description">{{ $holiday->description }}</textarea>
                                            </div>
                                        </fieldset>
