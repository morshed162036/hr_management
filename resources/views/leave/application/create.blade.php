...
<div class="content-header row">
    <div class="content-header-left col-12 mb-2 mt-1">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h5 class="content-header-title float-left pr-1 mb-0">Leave Application Create</h5>
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb p-0 mb-0">
                        <li class="breadcrumb-item"><a href="{{ route('dashboard') }}"><i class="bx bx-home-alt"></i></a>
                        </li>
                        <li class="breadcrumb-item"><a href="{{ route('leave-application.index') }}">Leave Applications</a>
                        </li>
                        <li class="breadcrumb-item active">Leave Application Create
                        </li>
                    </ol>
                </div>
            </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-content">
                        <form action="{{ route('leave-application.store') }}" method="post" enctype="multipart/form-data"> @csrf
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-10">
                                        <fieldset>
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Enter Employee ID" aria-describedby="basic-Createon1" name="employee_id" required>
                                            </div>
                                        </fieldset>
                                        <fieldset class="mt-2">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <select class="form-control" name="leave_id" id="" required>
                                        ...
                                        <fieldset class="mt-2">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="date" class="form-control" aria-describedby="basic-Createon1" name="from" required>
                                            </div>
                                        </fieldset>
                                        <fieldset class="mt-2">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="date" class="form-control" placeholder="Department Name" aria-describedby="basic-Createon1" name="to" required>
                                            </div>
                                        </fieldset>
                                        <fieldset class="mt-2">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="number" class="form-control" placeholder="0" aria-describedby="basic-Createon1" name="days" required>
                                            </div>
                                        </fieldset>
                                        <fieldset class="mt-2">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <textarea class="form-control" id="basicTextarea" rows="3" placeholder="" name="reason"></textarea>
                                            </div>
                                        </fieldset>
                                        <input type="text" name="type" value="Offline" hidden>
                                        <fieldset class="mt-2">
                                            <h5>Document</h5>
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                                ...
                                                <input type="file" class="form-control" placeholder="Department Name" aria-describedby="basic-Createon1" name="document">
                                            </div>
                                        </fieldset>
