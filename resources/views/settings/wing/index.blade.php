        ...
        <div class="content-header-left col-12 mb-2 mt-1">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    ...
                    @endif
                    <h5 class="content-header-title float-left pr-1 mb-0">Wing Table</h5>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h5 class="card-title">Wing List</h5>
                            <div class="heading-elements">
                                <ul class="list-inline mb-0">
                                    <li class="ml-2"><a href="{{ route('wings.create') }}" class="btn btn-primary">+ Create</a></li>
                                </ul>
                            </div>
                        </div>
                                        ...
                                        <tbody>
                                            @if ($wings)
                                                @foreach ($wings as $wing)
                                                    <tr>
                                                        <td class="text-bold-600" >{{ $wing->title }}</td>
                                                        ...
                                                        <td>
                                                            <div class="dropdown">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right">
                                                                    <a class="dropdown-item" href="{{ route('wings.edit',$wing->id) }}"><i class="bx bx-edit-alt mr-1"></i> edit</a>
                                                                    <form action="{{ route('wings.destroy',$wing->id) }}" method="post"> @csrf @method('Delete')
