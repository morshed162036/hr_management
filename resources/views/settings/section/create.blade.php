...
<div class="content-header row">
    <div class="content-header-left col-12 mb-2 mt-1">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h5 class="content-header-title float-left pr-1 mb-0">Section Create</h5>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-content">
                        <form action="{{ route('section.store') }}" method="post" enctype="multipart/form-data"> @csrf
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-10">
                                        <fieldset>
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Section Name" aria-describedby="basic-Createon1" name="title" required>
                                            </div>
                                        </fieldset>
