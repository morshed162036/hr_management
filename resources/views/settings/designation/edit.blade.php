                                    ...
                                    <div class="col-md-10">
                                        <fieldset>
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Designation Name" aria-describedby="basic-Createon1" name="title" value="{{ $designation->title }}" required>
                                            </div>
                                        </fieldset>
                                        ...
                                        <fieldset class="mt-2">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <textarea class="form-control" id="basicTextarea" rows="3" placeholder="" name="description">{{ $designation->description }}</textarea>
                                            </div>
                                        </fieldset>
