        ...
        <div class="content-header-left col-12 mb-2 mt-1">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    ...
                    @endif
                    <h5 class="content-header-title float-left pr-1 mb-0">Grade Table</h5>
                        ...
                        <div class="card-header">
                            ...
                            <div class="heading-elements">
                                <ul class="list-inline mb-0">
                                    <li class="ml-2"><a href="{{ route('grade.create') }}" class="btn btn-primary">+ Create</a></li>
                                </ul>
                            </div>
                        </div>
                                        ...
                                        <tbody>
                                            @if ($grades)
                                                @foreach ($grades as $grade)
                                                    <tr>
                                                        <td class="text-bold-600" >{{ $grade->title }}</td>
                                                        ...
                                                        <td>
                                                            <div class="dropdown">
                                                                ...
                                                                <div class="dropdown-menu dropdown-menu-right">
                                                                    <a class="dropdown-item" href="{{ route('grade.edit',$grade->id) }}"><i class="bx bx-edit-alt mr-1"></i> edit</a>
                                                                    <form action="{{ route('grade.destroy',$grade->id) }}" method="post"> @csrf @method('Delete')
