...
<div class="content-header row">
    <div class="content-header-left col-12 mb-2 mt-1">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h5 class="content-header-title float-left pr-1 mb-0">Branch Edit</h5>
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb p-0 mb-0">
                        ...
                        <li class="breadcrumb-item active">Branch Office Edit
                        </li>
                    </ol>
                </div>
            </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-content">
                        <form action="{{ route('branch.update',$branch->id) }}" method="post" enctype="multipart/form-data"> @csrf @method('put')
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-md-10">
                                        <fieldset>
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Branch Name" aria-describedby="basic-Createon1" name="title" value="{{ $branch->title }}" required>
                                            </div>
                                        </fieldset>
                                        <fieldset class="mt-2">
                                            <h5>Phone</h5>
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="01xxxxxxx" name="phone" value="{{ $branch->phone }}" min="11">
                                            </div>
                                        </fieldset>
                                        <fieldset class="mt-2">
                                            <h5>Email</h5>
                                            <div class="input-group">
                                                ...
                                                <input type="email" class="form-control" value="{{ $branch->email }}" placeholder="branch@gmail.com" name="email">
                                            </div>
                                        </fieldset>
                                        <fieldset class="mt-2">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <textarea class="form-control" id="basicTextarea" rows="3" placeholder="" name="address">{{ $branch->address }}</textarea>
                                            </div>
                                        </fieldset>
                                        <fieldset class="mt-2">
                                            <h5>Description</h5>
                                            <div class="input-group">
                                                ...
                                                <textarea class="form-control" id="basicTextarea" rows="3" placeholder="" name="description">{{ $branch->description }}</textarea>
                                            </div>
                                        </fieldset>
                                        <fieldset class="mt-2">
