...
<div class="content-header row">
    <div class="content-header-left col-12 mb-2 mt-1">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h5 class="content-header-title float-left pr-1 mb-0">Previous Promotion History</h5>
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb p-0 mb-0">
                        <li class="breadcrumb-item"><a href="{{ route('dashboard') }}"><i class="bx bx-home-alt"></i></a>
                        </li>
                        <li class="breadcrumb-item active">Promotion History Create
                        </li>
                    </ol>
                </div>
            </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form-horizontal" action="{{ route('promotion.create','previous') }}" method="post" enctype="multipart/form-data"> @csrf
                                <div class="row">
                                    <div class="col-sm-6">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <div class="controls">
                                                    ...
                                                    <input type="text" name="designation" class="form-control"  readonly value="{{ $employee->designation->title }}" >
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="card">
                                                <div class="card-header">
                                                    <h4 class="card-title">
                                                        Previous Promotion Details Entry
                                                    </h4>
                                                </div>
                                                <div class="card-content">
                                                    <div class="card-body">
                                                        <form class="form repeater-default" action="{{ route('promotion.store','previous') }}" method="post" enctype="multipart/form-data"> @csrf
                                                            <div data-repeater-list="promotion-history">
                                                                <div data-repeater-item>
                                                                    <div class="row justify-content-between">
                                                                        <div class="col-md-2 col-sm-12 form-group">
                                                                            <label for="Date">Promoted Date </label>
                                                                            <input type="date" class="form-control" id="Date" name="promotion_date">
                                                                        </div>
                                                                        <div class="col-md-2 col-sm-12 form-group">
                                                                            <label for="previous_designation">Previous Designation</label>
                                                                            <select name="previous_designation" id="previous_designation" class="form-control">
                                                                        ...
                                                                        <div class="col-md-2 col-sm-12 form-group">
                                                                            <label for="current_designation">Promoted Designation</label>
