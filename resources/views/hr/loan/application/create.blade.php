...
<div class="content-header row">
    <div class="content-header-left col-12 mb-2 mt-1">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h5 class="content-header-title float-left pr-1 mb-0">New Loan Application</h5>
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb p-0 mb-0">
                        <li class="breadcrumb-item"><a href="{{ route('dashboard') }}"><i class="bx bx-home-alt"></i></a>
                        </li>
                        <li class="breadcrumb-item active">Loan Apply
                        </li>
                    </ol>
                </div>
            </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form-horizontal" action="{{ route('loan-application.create') }}" method="post" enctype="multipart/form-data"> @csrf
                                <div class="row">
                                    <div class="col-sm-6">
        ...
        <section id="basic-input">
            <div class="row">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-content">
                            <form action="{{ route('loan-application.store') }}" method="post" enctype="multipart/form-data"> @csrf
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                    ...
                                    <div class="row">
                                                ...
                                                <div class="controls">
                                                    ...
                                                    <select name="load_id" id="load_id" class="form-control" required>
                                                        ...
                                                        @foreach ($loans as $loan)
                                                            <option value="{{ $loan->id }}">{{ $loan->title }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <div class="controls">
                                                    <h5>Amount</h5>
                                                    <input type="text" name="loan_amount" class="form-control" placeholder="0" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <div class="controls">
                                                    <h5>Total Month</h5>
                                                    <input type="text" name="total_month" class="form-control" placeholder="0" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <div class="controls">
                                                    ...
                                                    <input type="text" name="installment_amount" class="form-control" placeholder="0" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                <div class="controls">
                                                    <h5>Remarks</h5>
                                                    <input type="text" name="remarks" class="form-control" placeholder="Any Note?">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <input type="text" value="{{ $employee->user_id }}" hidden name="user_id">
                                    <button type="submit" class="btn btn-primary mt-2 btn-lg mx-1">Apply</button>
                                </div>
                            </form>
                        </div>
                    </div>
