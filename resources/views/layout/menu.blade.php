                    ...
                    <ul class="nav navbar-nav float-right">
                        ...
                        <li class="dropdown dropdown-user nav-item"><a
                                ...
                                <div class="user-nav d-sm-flex d-none">
                                    <span
                                        class="user-name">{{ Auth::guard('web')->user()->user_name }}</span>
                                         {{-- <span
                                        ...
                                        src="@if(Auth::guard('web')->user()->profile)
            ...
            <ul class="nav navbar-nav flex-row">
                <li class="nav-item mr-auto"><a class="navbar-brand" href="">
                        <div class="brand-logo"><img class="logo"
                                src="{{ asset('admin_template/app-assets/images/logo/hr-logo.png')}}" /></div>
                        <h2 class="brand-text mb-0 mr-0">HR Software</h2>
                    </a></li>
