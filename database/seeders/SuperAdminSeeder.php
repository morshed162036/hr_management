...
class SuperAdminSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $info = [
            ['id'=>'1','user_id'=>'1','employee_id'=>'sup-1','first_name'=>'Morshed','last_name'=>'Ahmed','phone'=>'018xxxxxxxx','address'=>'mirpur','state'=>'Dhaka','country'=>'Bangladesh','nid'=>'xxxxxxx','gender'=>'Male','join_date'=>date('Y-m-d'),'employee_type'=>'Master Roll','wing_id'=>'1','branch_id'=>'1','department_id'=>'2','section_id'=>'1','grade_id'=>'1','designation_id'=>'1','report_to'=>'0','pf&gratuity_eligiblity'=>'No']
        ];
